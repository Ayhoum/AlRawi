...
<head>
    ...
    <!-- Document Title
    ============================================= -->
    <title>Al Rawi Theorie | Wrong LogIn</title>
                ...
                <div class="container vertical-middle divcenter clearfix">
                    ...
                    <div class="panel panel-default divcenter noradius noborder" style="max-width: 400px;">
                        <div class="panel-body" style="padding: 40px;">
                                <h3 class="text-center">البيانات التي أدخلتها غير صحيحة</h3>

                                <div class="col_full nobottommargin">
                                    <a href="login.php"><button class="button button-3d button-black nomargin" style="width: 100%" id="login_submit" name="login_submit">المحاولة مرة أخرى</button></a>
                                </div>
