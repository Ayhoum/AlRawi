...
<!--					</div>-->
        ...
        <div class="remodal" data-remodal-id="modal">
            ...
            <p style="direction: rtl">
                عزيزنا الزائر،<br><br>
                بدخولك إلى الموقع واستخدام خدماتنا فأنت تصرح بالموافقة على أنه لن يتم من قبلك أي تسريب للأسئلة الموجودة في موقعنا، أو نشرها بشكل غير قانوني، إذ أن أي إجراء من هذا القبيل سيعرض صاحبه آسفين للملاحقة القانونية.<br>نرجوا لكم وللجميع الفائدة من خدماتنا
