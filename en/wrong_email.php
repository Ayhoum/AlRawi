...
if(isset($_POST['code_submit'])){
    ...
    $getAgent = mysqli_query($mysqli_en, $query);
    ...
    $getCode = mysqli_query($mysqli_en, $codeQuery);
                ...
                <div class="container vertical-middle divcenter clearfix">
                    ...
                    <div class="panel panel-default divcenter noradius noborder" style="max-width: 400px;">
                        <div class="panel-body" style="padding: 40px;">
                            <h4 class="text-center">هذا البريد غير مسجل في موقعنا يرجى تسجيل حساب جديد</h4>
                            ...
                            <div class="col_full topmargin-sm nobottommargin">
                                <a href="signup.php" class="fright text-center" style="width: 100%">تسجيل حساب جديد</a>
                            </div>
                        </div>
                    </div>
