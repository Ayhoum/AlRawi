                            ...
                            <div class="row">
                                <div class="col-sm-8">
                                    ...
                                    if (file_exists('dashboardAlrawi/examImagesTrucks/free/' . $picture)) {
                                        echo "<img class='img-fluid img-thumbnail' src='dashboardAlrawi/examImagesTrucks/free/$picture'/>";
                                    }
                                    ?>
                                </div>
...
<?php if (isset($_SESSION['email'])){ ?>
    ...
    <?php } ?>
<a href="continue_free_exam_trucks.php?exam_id=<?php echo $qId;?>&from=<?php echo $from;?>" class="button button-rounded button-green button-reveal button-large button-border "><i
