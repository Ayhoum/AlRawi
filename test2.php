    ...
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <div class="navbar-brand navbar-brand-centered" id="showTime"><span style="font-size: 25px;"
                                                                                id="count"></span>
                <button class="btn btn-danger" id="pause"><i class="fa fa-pause"></i></button>
                <button class="btn btn-success" id="resume"><i class="fa fa-play"></i></button>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <form method="post" action="free_check_answers.php?id=<?php echo $setId; ?>" enctype="multipart/form-data">
            ...
            <div id='sBetween' class='slideBetween'>
                ...
                <h4 style='direction: rtl;' class='text-center topmargin-sm'>عند إجابتك على أحد الأسئلة يمكنك الضغط على
                    زر (السؤال التالي) للانتقال للسؤال الذي يليه</h4>
            ...
            while ($row = mysqli_fetch_assoc($selectQuestions)) {
                ...
                $picture = $row['PICTURE'];
                $type = $row['TYPE'];
                echo "<div class='slideShowSlides slidesFade'>";
...
<!--                <a class="next" onclick="plusSlides();">&#10095;</a>-->
            ...
            <button name="submit" style="bottom: 40px;width:80%;font-family: 'DroidArabicKufiRegular';"
                    id="submitBut" class="btn-lg btn btn-success center center-block" value="Submit" type="submit">
                إستعراض النتيجة
            </button>

            <button type="button" id="nxtBut" onclick="nextQuestion()" class="btn btn-success btn-lg"
...
<!--    <div class="slideShowSlides slidesFade">-->
