...
if(isset($_POST['create'])){
    ...
    if (!$result) {
        ...
        header("Location: manage_paid_exams_nl.php?id=$lastId");
    }
}
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-title">
                            <h4 class="float-left">Add New Paid Dutch Exam</h4>
                        </div>
                    </div>
                </div><!-- end .page title-->
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-card margin-b-30">
                            ...
                            <div class="panel-body  p-xl-3">
                                <form method="post" action="add_paid_exam_nl.php" class="form-horizontal" data-toggle="validator">
