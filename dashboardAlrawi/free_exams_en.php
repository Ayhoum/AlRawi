        ...
        <div class="page-content-wrapper">
            <div class="content-wrapper container">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-title">
                            <h4 class="float-left">Free Exams English</h4>
                        </div>
                    </div>
                </div><!-- end .page title-->
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <?php if($status == "VISIBLE"){?>
                                            <a href="free_exams_en.php?change_to_invisible=<?php echo $id ?>" data-toggle="tooltip" title="" class="btn btn-secondary" data-original-title="View"><i class="fa fa-eye-slash"></i></a>

                                        <?php }else{ ?>
                                            <a href="free_exams_en.php?change_to_visible=<?php echo $id ?>" data-toggle="tooltip" title="" class="btn btn-success" data-original-title="View"><i class="fa fa-eye"></i></a>

                                        <?php } ?>
                                        <a href="edit_free_exam_info_en.php?id=<?php echo $id; ?>"  data-toggle="tooltip" title="" class="btn btn-warning" data-original-title="Delete"><i class="fa fa-cog fa-spin"></i></a>

                                        <a href="manage_free_exams_en.php?id=<?php echo $id; ?>" data-toggle="tooltip" title="" class="btn btn-primary" data-original-title="Edit"><i class="fa fa-pencil"></i></a>
                                    </td>
                                </tr>
                                <?php
                            }
                ...
                if(isset($_GET['change_to_visible'])){
                    ...
                    header("Location: free_exams_en.php");
                }
