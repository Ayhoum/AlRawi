                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-title">
                            <h4 class="float-left">Edit Free English Exam</h4>
                        </div>
                    </div>
                </div><!-- end .page title-->
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-card margin-b-30">
                            ...
                            <div class="panel-body  p-xl-3">
                                <form method="post" action="edit_free_exam_info_en.php?id=<?php echo $setId;?>" class="form-horizontal" data-toggle="validator">
