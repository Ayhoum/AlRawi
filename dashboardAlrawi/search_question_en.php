                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-title">
                            <h4 class="float-left">Search an English question</h4>
                        </div>
                    </div>
                </div><!-- end .page title-->
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-card margin-b-30">
                            ...
                            <div class="panel-body  p-xl-3">
                                <form method="post" action="search_question_en.php" class="form-horizontal" data-toggle="validator">
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-card margin-b-30">
                            ...
                            if(isset($_POST['search'])){
                                ...
                                $selectQuestions = mysqli_query($mysqli_en,$quesQuery);
                                while($row = mysqli_fetch_assoc($selectQuestions)){
                                    ...
                                    ?>
                                    <div class="panel-heading">
                                        <a href="paid_question_en.php?source=edit&id=<?php echo $qID;?>&qset=<?php echo $questionExam;?>"><div class="text-center btn-success" style="font-size: 22px;padding: 5px;"><?php echo 'Exam ' . $questionExam;?>
                                            <?php echo ' - ';?>
                                                <?php echo 'Question ' . $convertedId;?></div></a>
