...
if(isset($_POST['update'])){
    ...
    $query  = "UPDATE FREE_QUESTION_SET_TRUCK SET EXAM_NAME = '{$examName}' WHERE ID = $setId";
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-title">
                            <h4 class="float-left">Edit Free Exam <b style="color: #2A094A;">Trucks</b></h4>
                        </div>
                    </div>
                </div><!-- end .page title-->
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-card margin-b-30">
                            ...
                            <div class="panel-heading">
                                Update Exam Name <b style="color: #2A094A;">Trucks</b>
                            </div>
                            <div class="panel-body  p-xl-3">
                                <form method="post" action="edit_free_exam_info_trucks.php?id=<?php echo $setId;?>" class="form-horizontal" data-toggle="validator">
