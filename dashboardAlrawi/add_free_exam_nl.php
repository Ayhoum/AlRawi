...
if(isset($_POST['create'])){
    ...
    $lastId = mysqli_insert_id($mysqli_nl);
    $beginValue  = (($lastId -1) * 65) + 1;
    $query  = "UPDATE FREE_QUESTION_SET SET BEGIN_ID = $beginValue WHERE ID= $lastId";
    $result = mysqli_query($mysqli_nl, $query);

    if (!$result) {
        die("Failed to create a new exam". mysqli_error($mysqli_nl));
    } else {
        header("Location: manage_free_exams_nl.php?id=$lastId");
    }
}
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-title">
                            <h4 class="float-left">Add New Free Dutch Exam</h4>
                        </div>
                    </div>
                </div><!-- end .page title-->
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-card margin-b-30">
                            ...
                            <div class="panel-body  p-xl-3">
                                <form method="post" action="add_free_exam_nl.php" class="form-horizontal" data-toggle="validator">
