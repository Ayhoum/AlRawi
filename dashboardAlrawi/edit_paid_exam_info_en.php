...
if(isset($_POST['update'])){
    ...
    if (!$result) {
        die("Failed to update a new exam". mysqli_error($mysqli_en));
    } else {
        ...
        <div class="page-content-wrapper">
            <div class="content-wrapper container">
                ...
                <?php
                    ...
                    $getName = mysqli_query($mysqli_en,$query);
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-card margin-b-30">
                            ...
                            <div class="panel-body  p-xl-3">
                                <form method="post" action="edit_paid_exam_info_en.php?id=<?php echo $setId;?>" class="form-horizontal" data-toggle="validator">
