...
if (isset($_POST['submit'])) {
    ...
    if (!empty($newPicture_tmp)) {
        ...
        if (file_exists("examsImagesEN/free/$oldPicture")) {
            unlink("examsImagesEN/free/$oldPicture");
        }
    ...
    <div class="col-md-12">
        <div class="panel panel-card margin-b-30">
            <div class="panel-body  p-xl-3">
                ...
                <form method="post" action="edit_free_question_en.php?qset=<?php echo $qset;?>&id=<?php echo $setId;?>" data-toggle="validator" enctype="multipart/form-data">
                        ...
                        <div class="col-md-12">
                            <div class="row" style="margin-top: 10px;">
                                <div class="col-md-6">
                                    ...
                                    if($pic != "Empty") {
                                        ?>
                                        <center><img src="examsImagesEN/free/<?php echo $pic; ?>"
