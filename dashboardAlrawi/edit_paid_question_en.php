...
//        $number = 4;
    ...
    move_uploaded_file($newPicture_tmp, "examsImagesEN/paid/" . $newPicture);
    if (!empty($newPicture_tmp)) {
        ...
        if (file_exists("examsImagesEN/paid/$oldPicture")) {
            unlink("examsImagesEN/paid/$oldPicture");
        }
...
<?php
$query = "SELECT * FROM EXAM_QUESTION WHERE NUMBER = $setId";
$select_question = mysqli_query($mysqli_en, $query);
    ...
    <div class="col-md-12">
        <div class="panel panel-card margin-b-30">
            <div class="panel-body  p-xl-3">
                ...
                <form method="post" action="edit_paid_question_en.php?qset=<?php echo $qset; ?>&id=<?php echo $setId; ?>"
                            ...
                            <div class="row" style="margin-top: 10px;">
                                <div class="col-md-6">
                                    ...
                                    <?php
                                        if($pic != "Empty") {
                                            ?>
                                            <center><img src="examsImagesEN/paid/<?php echo $pic; ?>"
                    ...
                    <div class="form-group row"><label>Question Type : </label>
                        <select id="type" class="form-control m-b" style="direction: ltr;" name="type" required>
                            ...
                            <option value="response" <?php if ($type == "response" ){echo "selected"; }?>>Response</option>
                            <option value="yesNo" <?php if ($type == "yesNo" ){echo "selected"; }?>>Yes / No</option>
                            <option value="numInp" <?php if ($type == "numInp" ){echo "selected"; }?>>Number Input</option>
                            <option value="multiChoice2" <?php if ($type == "multiChoice2" ){echo "selected"; }?>>Multiple Choice (2)</option>
                            <option value="multiChoice3" <?php if ($type == "multiChoice3" ){echo "selected"; }?>>Multiple Choice (3)</option>
                            <option value="multiChoice4" <?php if ($type == "multiChoice4" ){echo "selected"; }?>>Multiple Choice (4)</option>
                            <option value="advantage3" <?php if ($type == "advantage3" ){echo "selected"; }?>>Priorities (3)</option>
                            <option value="advantage4" <?php if ($type == "advantage4" ){echo "selected"; }?>>Priorities (4)</option>
                        </select>
                    </div>
                ...
                <div class="form-group row">
                    <a href="manage_paid_exams_en.php?id=<?php echo $qset; ?>">
