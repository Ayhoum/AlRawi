...
//        $number = 4;
    ...
    if (!empty($newPicture_tmp)) {
        ...
        if (file_exists("examsImagesNL/paid/$oldPicture")) {
            unlink("examsImagesNL/paid/$oldPicture");
        }
    ...
    <div class="col-md-12">
        <div class="panel panel-card margin-b-30">
            <div class="panel-body  p-xl-3">
                            ...
                            <div class="row" style="margin-top: 10px;">
                                <div class="col-md-6">
                                    ...
                                    <?php
                                        if($pic != "Empty") {
                                            ?>
                                            <center><img src="examsImagesNL/paid/<?php echo $pic; ?>"
                ...
                <div class="form-group row">
                    <a href="manage_paid_exams_nl.php?id=<?php echo $qset; ?>">
