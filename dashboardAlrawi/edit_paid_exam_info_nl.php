...
if(isset($_POST['update'])){
    ...
    $query  = "UPDATE QUESTION_SET SET EXAM_NAME = '{$examName}' WHERE ID = $setId";
    $result = mysqli_query($mysqli_nl, $query);
    if (!$result) {
        die("Failed to update a new exam". mysqli_error($mysqli_nl));
    } else {
    ...
    <div class="page-container">
        ...
        <aside class="sidebar">
            <nav class="sidebar-nav">
                ...
                <!-- END SIDEBAR MENU -->
            </nav>        </aside>        <!-- BEGIN CONTENT BODY -->
        <div class="page-content-wrapper">
            <div class="content-wrapper container">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-title">
                            <h4 class="float-left">Edit Paid Dutch Exam</h4>
                        </div>
                    </div>
                </div><!-- end .page title-->
                ...
                <?php
                    ...
                    $getName = mysqli_query($mysqli_nl,$query);
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-card margin-b-30">
                            ...
                            <div class="panel-body  p-xl-3">
                                <form method="post" action="edit_paid_exam_info_nl.php?id=<?php echo $setId;?>" class="form-horizontal" data-toggle="validator">
