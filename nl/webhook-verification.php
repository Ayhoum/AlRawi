	...
	if ($payment->isPaid() == TRUE)
	{
        ...
        if (mysqli_num_rows($updateAgent) == 1) {
            while ($row = mysqli_fetch_assoc($updateAgent)) {
                ...
                $run = mysqli_query($mysqli_nl,$updateQuery);
            }
        }
...
function database_write ($order_id, $status,$mysqli_nl, $userID)
{
