...
if(isset($_POST['login_submit'])) {
    ...
    $email = mysqli_real_escape_string($mysqli_nl, $email);
    $pass = $_POST['login_password'];
    $pass = mysqli_real_escape_string($mysqli_nl, $pass);


    $query = "SELECT * From Users WHERE EMAIL = '{$email}' ";
    $getHashAgent = mysqli_query($mysqli_nl, $query);
        ...
        while ($row = mysqli_fetch_assoc($getHashAgent)) {
            ...
            if ((password_verify($pass, $hash))) {
                if($status == 1){
                    ...
                    $runSelect = mysqli_query($mysqli_nl,$selectQuery);
                    if(mysqli_num_rows($runSelect) > 0){
                        ...
                        if(date('Y-m-d H:i:s') < date("Y-m-d H:i:s", strtotime($time.'+2 hour'))){
                            ...
                            if($times > 1){
                                ...
                                $runSelectB = mysqli_query($mysqli_nl,$selectB);
                                ...
                                $runDelete = mysqli_query($mysqli_nl,$queryDelete);
                            }
                        }
                        ...
                        $runInsert = mysqli_query($mysqli_nl,$queryInsert);
                    }
