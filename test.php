...
<nav class="navbar navbar-default" role="navigation">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <div class="navbar-brand navbar-brand-centered" id="showTime"><span style="font-size: 25px;" id="count"></span> <button class="button button-mini button-circle button-red" id="pause"> إيقاف الوقت</button><button class="button button-mini button-circle button-green" id="resume"> تشغيل الوقت</button> </div>
        </div>
        ...
        <div class="collapse navbar-collapse" id="navbar-brand-centered">
            <ul class="nav navbar-nav">
                <li class="text-center">
                    <a href="#" style="color:#fff;"><button onclick="stopExam()" class="button button-rounded button-reveal button-small button-red"><i class="fa fa-times"></i><span>إيقاف الإمتحان</span></button></a>
                    </li>
            </ul>
...
<!--        <button class="print">Print</button>-->
    ...
    <footer class="hidden-sm hidden-xs">
        <p>© 2017 Alrawi Theorie | Developed by <a target="_blank" style="color:#000; text-decoration:none;"
                                                   href="http://www.el-semicolon.nl">El-SemiColon; <img src="images/logoES.png" style="width: 64px;height: 64px;"/></a></p>
    </footer>
